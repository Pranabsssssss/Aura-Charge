...
scrollbar-width: thin;
        ...
        @keyframes pulseGlow {
            from { box-shadow: 0 0 20px rgba(0, 191, 255, 0.3); }
            to { box-shadow: 0 0 40px rgba(0, 191, 255, 0.6), 0 0 80px rgba(0, 191, 255, 0.2); }
        }
...
<body class="bg-black text-white font-inter">
    ...
    <header class="main-header">
        <nav class="flex items-center justify-between px-6 py-4">
            ...
            <a href="/signin" class="signin-button px-5 sm:px-6 py-2 rounded-full border-2 border-cyan-400/40 text-cyan-400 transition-all duration-400 fade-in-right delay-300">
    ...
    <main class="min-h-full">
        <section class="hero-bg min-h-full flex items-center justify-center relative overflow-hidden">
            ...
            <div class="absolute inset-0 overflow-hidden">
                ...
                <div class="absolute top-3/4 right-1/4 w-1 h-1 bg-blue-400 rounded-full pulse-glow" style="animation-delay: 1s;"></div>
                <div class="absolute top-1/2 left-3/4 w-1.5 h-1.5 bg-cyan-300 rounded-full pulse-glow" style="animation-delay: 2s;"></div>
            ...
            <div class="container mx-auto px-6 py-20 text-center relative z-10">
                <div class="max-w-4xl mx-auto">
                    <!-- Wireless Charging Car Animation -->
                    <div class="floating mb-12 scale-in delay-400 relative z-30 mt-8">
                        <div class="relative w-80 h-40 mx-auto">
                            <!-- Charging Station Base -->
                            <div class="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-16 h-8 bg-gradient-to-t from-gray-700 to-gray-600 rounded-lg border border-cyan-400/30">
                                <!-- Charging pad with wireless waves -->
                                <div class="absolute -top-2 left-1/2 transform -translate-x-1/2">
                                    <div class="w-4 h-4 bg-cyan-400 rounded-full charging-pulse"></div>
                                    <!-- Wireless energy waves -->
                                    <div class="wireless-wave absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-8 h-8 border-2 border-cyan-400/50 rounded-full"></div>
                                    <div class="wireless-wave absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-12 h-12 border-2 border-cyan-400/40 rounded-full" style="animation-delay: 0.3s;"></div>
                                    <div class="wireless-wave absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-16 h-16 border-2 border-cyan-400/30 rounded-full" style="animation-delay: 0.6s;"></div>
                                    <div class="wireless-wave absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-20 h-20 border-2 border-cyan-400/20 rounded-full" style="animation-delay: 0.9s;"></div>
                                </div>
                                <!-- Station indicator light -->
                                <div class="absolute top-1 right-1 w-1.5 h-1.5 bg-green-400 rounded-full pulse-glow"></div>
                            </div>
                            ...
                            <div class="absolute bottom-8 left-1/2 transform -translate-x-1/2">
                                <svg width="120" height="60" viewBox="0 0 120 60" class="car-charging">
                                    <!-- Car Body -->
                                    <rect x="10" y="25" width="80" height="20" rx="8" fill="url(#carGradient)" stroke="rgba(0, 191, 255, 0.3)" stroke-width="1"/>
                                    <!-- Car Roof -->
                                    <rect x="25" y="15" width="50" height="15" rx="6" fill="url(#roofGradient)" stroke="rgba(0, 191, 255, 0.2)" stroke-width="1"/>
                                    <!-- Windshield -->
                                    ...
                                    <!-- Wheels -->
                                    <circle cx="25" cy="50" r="8" fill="#333" stroke="rgba(0, 191, 255, 0.4)" stroke-width="2"/>
                                    <circle cx="75" cy="50" r="8" fill="#333" stroke="rgba(0, 191, 255, 0.4)" stroke-width="2"/>
                                    ...
                                    <!-- Charging Port -->
                                    <rect x="45" y="40" width="10" height="4" rx="2" fill="rgba(0, 191, 255, 0.8)" class="charging-port"/>
                                    <!-- Battery Indicator -->
                                    <rect x="35" y="30" width="30" height="6" rx="3" fill="rgba(0, 0, 0, 0.3)" stroke="rgba(0, 191, 255, 0.3)" stroke-width="1"/>
                                    <rect x="37" y="32" width="26" height="2" rx="1" fill="url(#batteryGradient)" class="battery-fill"/>
                                ...
                                <div class="absolute -top-8 left-1/2 transform -translate-x-1/2 text-center">
                                    ...
                                    <div class="flex space-x-1">
                                        <div class="w-1 h-3 bg-cyan-400 rounded charging-bar" style="animation-delay: 0s;"></div>
                                        <div class="w-1 h-3 bg-cyan-400/60 rounded charging-bar" style="animation-delay: 0.2s;"></div>
                                        <div class="w-1 h-3 bg-cyan-400/40 rounded charging-bar" style="animation-delay: 0.4s;"></div>
                                        <div class="w-1 h-3 bg-cyan-400/20 rounded charging-bar" style="animation-delay: 0.6s;"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <p class="text-xl md:text-2xl text-gray-300 mb-8 font-light fade-in-up delay-600 max-w-4xl mx-auto">
                        ...
                        <span class="text-purple-400 font-medium hover-glow">Manoj Sharma</span> to redefine EV charging.
                    </p>
                    ...
                    <!-- CTA Button -->
                    <a href="/signin" class="cta-button inline-block px-12 py-4 rounded-full text-lg font-semibold text-cyan-400 hover:text-white transition-all duration-300 relative fade-in-up delay-700">
                        Get Started
                ...
                <div class="grid md:grid-cols-3 gap-8 mt-20 max-w-6xl mx-auto">
                    <div class="feature-card bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-xl p-6 fade-in-up delay-800">
                        <div class="feature-icon w-12 h-12 bg-gradient-to-br from-cyan-400 to-blue-500 rounded-lg mb-4 flex items-center justify-center">
                        ...
                        <p class="text-gray-400">Advanced safety protocols ensure secure wireless power transfer with optimal efficiency rates.</p>
                    </div>
                    
                    <div class="feature-card bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-xl p-6 fade-in-up delay-900">
                        <div class="feature-icon w-12 h-12 bg-gradient-to-br from-blue-400 to-purple-500 rounded-lg mb-4 flex items-center justify-center">
                            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <p class="text-gray-400">Based on mutual induction principles, eliminating cables for seamless charging experience.</p>
                    </div>
                    
                    <div class="feature-card bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-xl p-6 fade-in-up delay-1000">
                        <div class="feature-icon w-12 h-12 bg-gradient-to-br from-green-400 to-cyan-500 rounded-lg mb-4 flex items-center justify-center">
                            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <p class="text-gray-400">Seamlessly integrates with any type of EV, making charging accessible for all vehicles.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="py-20 bg-gradient-to-b from-black to-gray-900 relative overflow-hidden">
            <div class="container mx-auto px-6">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
                    <div class="feature-card bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-6 text-center fade-in-up delay-200">
                        <div class="w-16 h-16 bg-gradient-to-br from-cyan-400 to-blue-500 rounded-full mx-auto mb-4 flex items-center justify-center">
                            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0z"></path>
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 6h3l2 7H9l-1-7h5z"></path>
                            </svg>
                        </div>
                    ...
                    <div class="feature-card bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-6 text-center fade-in-up delay-400">
                    ...
                    <div class="feature-card bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-6 text-center fade-in-up delay-600">
                        <div class="w-16 h-16 bg-gradient-to-br from-green-400 to-cyan-500 rounded-full mx-auto mb-4 flex items-center justify-center">
                            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="feature-card bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-6 text-center fade-in-up delay-800">
                        <div class="w-16 h-16 bg-gradient-to-br from-purple-400 to-pink-500 rounded-full mx-auto mb-4 flex items-center justify-center">
                            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="absolute inset-0 opacity-30">
        ...
        <div class="absolute bottom-0 right-1/4 w-80 h-80 bg-blue-500/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
    </div>
    
    <!-- Grid Pattern Overlay -->
    <div class="absolute inset-0 opacity-20" style="background-image: linear-gradient(rgba(0,191,255,0.1) 1px, transparent 1px), linear-gradient(90deg, rgba(0,191,255,0.1) 1px, transparent 1px); background-size: 50px 50px;"></div>
        ...
        <div class="flex justify-center mb-12">
            ...
            <div class="text-center max-w-2xl">
                <div class="flex items-center justify-center space-x-4 mb-6">
                    <div class="relative">
                        <img src="https://auraof.pranab.tech/logo.png" alt="Aura Charge" class="w-16 h-16 rounded-full border-2 border-cyan-400/50 shadow-lg" onerror="this.src=''; this.alt='Logo failed to load'; this.style.display='none';">
                        <div class="absolute inset-0 rounded-full bg-cyan-400/20 animate-ping"></div>
                    </div>
                    <div>
                        <h3 class="text-2xl font-bold gradient-text" style="font-family: 'Orbitron', monospace; background: linear-gradient(135deg, #00bfff, #1e90ff, #00ffff); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;">Aura Charge</h3>
                        <p class="text-gray-400 text-sm">Powering the Future</p>
                    </div>
                </div>
                <p class="text-gray-300 mb-6 leading-relaxed">
                    Experience the next generation of electric vehicle charging with our advanced network of smart charging stations. Clean energy, intelligent technology, seamless experience.
                </p>
            ...
            <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                <div class="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-6">
                    <div class="flex flex-col items-center md:items-start space-y-1">
                        <a href="https://github.com/pranabsssssss" target="_blank" rel="noopener noreferrer" class="text-cyan-400 hover:text-cyan-300 transition-colors font-medium">
                ...
                <button onclick="scrollToTop()" class="group relative w-12 h-12 bg-gradient-to-br from-cyan-400/20 to-blue-500/20 border border-cyan-400/30 rounded-xl flex items-center justify-center hover:border-cyan-400/60 transition-all duration-300 hover:scale-110">
                    <svg class="w-5 h-5 text-cyan-400 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 10l7-7m0 0l7 7m-7-7v18"></path>
                    </svg>
                    <div class="absolute inset-0 rounded-xl bg-gradient-to-br from-cyan-400/0 to-blue-500/0 group-hover:from-cyan-400/20 group-hover:to-blue-500/20 transition-all duration-300"></div>
                </button>
            </div>
        </div>
    </div>
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div class="absolute bottom-1/4 left-1/3 w-1.5 h-1.5 bg-cyan-300/20 rounded-full animate-bounce delay-1000"></div>
        <div class="absolute bottom-1/3 right-1/4 w-1 h-1 bg-blue-300/30 rounded-full animate-bounce delay-1500"></div>
    </div>
    ...
    <script>
     ...
     <script>
        // Client-side localStorage user check to redirect if logged in
        ...
        // Your existing Lenis smooth scroll and other JS code go here
        // Your existing animation handlers, particle generators, etc.
